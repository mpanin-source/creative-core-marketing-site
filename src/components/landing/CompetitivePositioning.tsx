...
const sections = [
  ...
  },
  {
    ...
    solution: "Front-load your budget to peak seasons. Don't spread it thin across 12 months. Same spend. 5–10x more leads.",
    cta: "See how seasonal positioning beats generic year-round waste",
    body: "You're running ads year-round. January, July, doesn't matter. Same budget. Same desperation. Most agencies do this because it's easier—set and forget. But when it's 85°F in July, NOBODY is searching for furnace repair.",
  },
  {
    icon: Shield,
    tag: "PAIN POINT #3",
    ...
    insight: "Jack Rabbit (Fort Myers-based) scales into Englewood by using PPC with strong offers ($0 service call). They can't win LSA there.",
    solution: "We use PPC to build your name in new markets first. Establish authority. Get reviews. THEN you move to LSA and own that market too.",
    cta: "Learn how we scale you regionally while protecting your margins",
    body: "You're crushing it in your home town. Everyone knows your name. Your LSA is performing. But when you try to expand to the next zip code over, you hit a wall.",
  },
];

const CompetitivePositioning = () => {
  return (
    <section className="section-padding" id="competitive">
          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="p-4 bg-tier-teal/5 border border-tier-teal/20 rounded-lg">
                  <p className="text-xs font-bold tracking-wider text-tier-teal uppercase mb-2">The Solution</p>
              ...
              <button
                ...
                className="flex items-center gap-2 text-sm text-accent hover:text-accent/80 font-semibold transition-colors group"
              >
                {section.cta}
