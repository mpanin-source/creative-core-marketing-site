    ...
    >
      ...
      <div className="grid sm:grid-cols-3 gap-5 mb-10">
        {items.map((item, i) => (
          ...
          >
            <div className="w-11 h-11 rounded-lg bg-coral/10 flex items-center justify-center mx-auto mb-4">
      ...
      <p className="text-sm font-semibold text-foreground">
        Total time investment: <span className="text-coral">~30 minutes</span> to launch your sprint.
      </p>
    </motion.div>
  </section>
);
