...
const trends = [
  ...
  { term: '"Roof replacement near me"', spike: "Apr–May", color: "bg-green-500" },
  { term: '"Solar installation"', spike: "Apr–Jun", color: "bg-amber-500" },
];
...
const ProofLayer = () => {
  return (
    <section className="section-padding bg-card" id="proof-layer">
      <div className="container-wide">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <p className="text-center text-muted-foreground text-sm mt-6 max-w-xl mx-auto">
            ...
            That's why your cost per lead drops 50–70% and your ROAS is 4x higher.
          </p>
        </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-accent/30">
                  ...
                  <th className="text-left p-4 text-xs font-bold tracking-wider text-accent uppercase">Seasonal Strategy</th>
