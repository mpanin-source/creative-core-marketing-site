    ...
    <AnimatePresence>
      {!dismissed && (
        <motion.div
          ...
          className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-2rem)] max-w-lg"
        >
          <div
            className="flex items-center justify-between gap-3 px-5 py-3 rounded-lg border border-safety/40"
            style={{
