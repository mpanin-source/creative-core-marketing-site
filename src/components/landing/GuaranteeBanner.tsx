...
const GuaranteeBanner = () => {
  return (
    <section className="px-6 py-16 md:px-8 md:py-20" id="guarantee">
      ...
      >
        <div className="rounded-xl p-8 md:p-12 text-center relative overflow-hidden" style={{ background: "hsl(100, 15%, 31%)" }}>
          <div className="relative z-10">
            <Shield className="w-10 h-10 mx-auto mb-4" style={{ color: "hsl(207, 38%, 76%)" }} />
