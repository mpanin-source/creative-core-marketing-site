...
const deliverables = [
  { icon: Search, title: "LOCAL SEO FOUNDATION", desc: "Schema markup deployment, NAP consistency across the major citation directories, full GBP setup and optimization, and on-page SEO basics." },
        ...
        >
          <div className="p-6 rounded-2xl border border-border bg-card/60 backdrop-blur-sm">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Ad spend (you pay Google directly) · SMS automation (in rollout) · Full website rebuilds (Foundation optimizes the site you have) · Social-media management
            </p>
          </div>
        </motion.div>
      </div>
