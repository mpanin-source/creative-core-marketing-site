...
const items = [
  ...
  },
  {
    ...
    details: [
      ...
      "Pre-configure campaign templates",
    ],
  },
];
...
const UpfrontFeeBreakdown = () => {
  return (
    <section className="section-padding" id="upfront-fee">
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          <div className="p-6 glass-card border-accent/20 rounded-xl">
            <p className="text-sm font-display font-bold text-foreground mb-2">
              TOTAL VALUE IF PURCHASED SEPARATELY: <span className="text-accent">$2,000+</span>
            </p>
