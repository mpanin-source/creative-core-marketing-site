...
const systems: System[] = [
  {
    ...
    href: "/services/seo",
    proofStat: "78%",
    proofLabel: "of homeowners buy from the first responder",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    name: "GEO & AI Search",
    body: "Schema for AI Overview eligibility. Atomic Answer formatting. Citation velocity across industry sources. Entity linking to Knowledge Graph. Multi-platform optimization for ChatGPT, Claude, Perplexity, Gemini.",
    href: "/services/geo",
    proofStat: "3.49%",
    proofLabel: "AI search conversion rate (vs 2.86% organic)",
  },
  {
    number: "04",
  ...
  },
  {
    ...
    body: "Behavioral triggers, lead scoring, nurture sequences, review acquisition systems. Voice AI for missed calls, SMS workflows for confirmations and follow-ups. We architect the systems; you handle the jobs.",
    href: "/services/marketing-automation",
    proofStat: "45%",
    proofLabel: "avg improvement in lead response time",
  },
  {
    number: "06",
    badge: "Beyond off-the-shelf",
    outcome: "Build the tool when off-the-shelf falls short.",
    name: "Custom Software Solutions",
    body: "Once we're inside your business and we've audited your funnel, we identify specific bottlenecks that off-the-shelf tools can't solve. Custom dispatching, lead scoring, integration bridges — built when the opportunity warrants it.",
    href: "/services/custom-software",
    proofStat: "—",
    proofLabel: "Project-based, scoped after CRO audit reveals the opportunity.",
  },
];
